...
#	valC <- M8[PC+2] 	Read V value
#	valP <- PC + 10  	Compute next PC
#Decode	
#	valB <- R[rB]		Read operand B from rB register
#Execute 
#	valE <- valB + valC; 	Perform addition operation at ALU 
#	set CC			Set condition code register
#Memory
#Write Back
#	R[rB] <- valE		Write back result to register rB
#PC Update
#	PC <- valP		Update PC
